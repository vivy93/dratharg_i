...
public class LoadMenu : MonoBehaviour {
	...
	public static string playerUsername { get; protected set; } //stores username once logged in
	private static string playerPassword = ""; //stores password once logged in
